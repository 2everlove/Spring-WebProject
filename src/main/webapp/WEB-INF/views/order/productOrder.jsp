	...
	<h2>주문/결제</h2>
		<form id="paymentAction" role="form" action="/paymentAction" method="post">
			<fieldset>
				...
				<div class="content2">
					<label>이름</label> <input class="view" type="text" value="${vo.user_name}"></input>
				</div>
				<div class="content2">
					<label>주소</label> <input class="view" type="text" value="${vo.user_address}"></input>
				</div>
			</fieldset>
			<fieldset>
				<label>결제 정보</label>
				<div class="content2">
					<label>상품 아이디</label> <input class="view" type="text" value="${pvo.product_id}"></input>
				</div>
				<div class="content2">
					<label>상품 개수</label>
					<select id="amount">
				...
				<div class="content2">
					<label>총 결제 금액</label> <input class="view" type="text" value="${pvo.pboard_unit_price}"></input>
				</div>
			</fieldset>
