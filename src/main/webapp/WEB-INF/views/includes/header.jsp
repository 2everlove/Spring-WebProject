	        ...
	        <div id="navbar__wrapper">
	            ...
	            <div class="navbar__wrapper-right">
		            <div class="navbar__menu-right">
		                ...
		                <button class="navbar__menu__item-member" onclick="location.href='myPage'"><i class="fas fa-user-alt"></i> 마이페이지</button>
		                <button class="navbar__menu__item-member" onclick="location.href='cart'"><i class="fas fa-shopping-cart"></i> 장바구니  /  배송조회</button>
