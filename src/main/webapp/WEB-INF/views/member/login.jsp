            ...
            <p id="errorMsgArea"></p>
                ...
                <fieldset id="login">
                    ...
                    <div class="login-group">
                    	<label>아이디</label>
                        <input class="login-box" placeholder="id" name="User_id" value="" autofocus>
                    </div>
                   
                    <div class="login-group">
                    	<label>비밀번호</label>
                        <input class="login-box" placeholder="Password" name="User_password" type="password" value="">
                    </div>
                    ...
                    <!-- Change this to a button or input when using this as a form -->
              		...
              		<div class="g-signin2" onclick="ClickLogin()" data-onsuccess="onSignIn"></div>
                        ...
                        <fieldset id="searchId" style="display: none;">
                        	<div style="display:inline; "><a href="/member"class="loginUpperBtn">&nbsp;회원가입</a></div><div style="float:right; "><c:if test="${!empty sessionScope.user}"></c:if></div>
                           <div class="login-group">
                           		<label>이름</label>
