...
public class MailService {		
	...
	public void welcomeMailSend() {
		 ...
		 * "smtp.gmail.com");// SMTP서버 prop.put("mail.smtp.auth", "true");// SMTP 서버의
		 * 인증사용 prop.put("mail.smtp.port", "587");// TLS 포트번호= 587, SSL 포트번호= 465
		 */		 
		...
		try {
			...
			InternetAddress to = new InternetAddress("jado2002@naver.com");
			msg.setRecipient(Message.RecipientType.TO, to);
			
            // 메일 제목
			msg.setSubject("환영합니다.", "UTF-8");
			// 메일 내용
			msg.setText("ID는 dreamingskywhale@gmail.com 입니다.", "UTF-8");
