...
public class UserVO {
	...
	private String User_enabled;	//? ?Œï¿½å ?™?˜™ ? ?„?…¢? ?Œ?’ ? ?ˆë»? 1
	private String User_type;		//? ?ˆ?„ ? ?ˆêµ¡æ²ƒ?„“?˜™ : A, ?–«ê¿¸í?£æ¯“ï¿? : E, ï¿½â‘¥ì¥’è?Œï¿½ : C
	private String User_regdate;
	private String User_gender;
	private String User_birth;
	private String User_address;
	private String User_interesting;
	private String User_enabledContent;	//ï¿½ë‡¡?º?– ì¨? ï¿½êµœ?º?– ì»²å ?ˆë±? - ? ?Œ?‚‹ç­Œë¥ê¶??‡‰ï¿? ? ?Œëµ¬å ?Œëµ? ? ?Œë¿³å ?ˆ?„ ? ?„?£ ï¿½ë‡¡?º?– ì¨?? ?ˆë¼£å ?ˆë¦?ç­Œë¡³?˜™ ï¿½ë‡¡?º?– ì¨?? ?ˆë¼£å ?ˆë¦? ? ?Œëµ å ?Œï¿½ï¿½ëª´å ï¿? ? ?™?˜™? ?Œ?‚¢
	private String file_pictureId;
	
	// ? ?Œ?½? ?ˆì§—åš¥?‰ªë®„ï¿½? ƒ? ?Œëµ¥å ?ˆ?“  ? ?ˆ?ˆ¡? ?Œ?’„? ?ˆë¦? ? ?„?…•?¶?‰?˜™
	String sessionkey;
	// ? ?Œ?½? ?ˆì§—åš¥?‰ªë®„ï¿½? ƒ? ?Œëµ¥å ?Œë²? ? ?Œï¿½å ?Œ?’?–«ê¿¸í?—è?Œï¿½
	Date sessionlimit;
